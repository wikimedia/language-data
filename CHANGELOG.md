...
2.  [Remove ruq-grek](https://github.com/wikimedia/language-data/pull/369)
3.  [Add Sabah Malay (msi)](https://github.com/wikimedia/language-data/pull/370)
4.  [Change hak configuration in line with core MediaWiki](https://github.com/wikimedia/language-data/pull/371)
5.  [Update Solomon Islands Pidgin (pis) autonym](https://github.com/wikimedia/language-data/pull/373)
6.  [Add Duala (dua)](https://github.com/wikimedia/language-data/pull/375)
7.  [Add Rukai (dru)](https://github.com/wikimedia/language-data/pull/376)
8.  [Add Ngiemboon (nnh)](https://github.com/wikimedia/language-data/pull/374)
9.  [Reorder yue-hans and add ro to U.K.](https://github.com/wikimedia/language-data/pull/377)
10. [Add Haryanvi (Arabic script; bgc-arab)](https://github.com/wikimedia/language-data/pull/381)
11. [Add Louisiana Creole (lou)](https://github.com/wikimedia/language-data/pull/378)
12. [Update the autonym of the Tigre language (tig)](https://github.com/wikimedia/language-data/pull/380)
13. [Add Jju (kaj) and Negeri Sembilan Malay (zmi)](https://github.com/wikimedia/language-data/pull/382)
14. [Add Cham languages (cja, cjm)](https://github.com/wikimedia/language-data/pull/384)
15. [Add Khoekhoe (a.k.a. Nama, naq)](https://github.com/wikimedia/language-data/pull/385)
16. [Add Acholi (ach) and Lango (laj)](https://github.com/wikimedia/language-data/pull/389)
17. [Update Komering (kge) autonym](https://github.com/wikimedia/language-data/pull/388)
18. [Add Mansi (mns)](https://github.com/wikimedia/language-data/pull/387)
19. [Update configuration for Manchu (mnc)](https://github.com/wikimedia/language-data/pull/386)
20. [Add several Malayo-Polynesian languages](https://github.com/wikimedia/language-data/pull/390)
21. [Update Kadazan Dusun (dtp) autonym](https://github.com/wikimedia/language-data/pull/394)
22. [Add Central Kanuri as a full-fledged language](https://github.com/wikimedia/language-data/pull/392)
23. [Add Anufo (cko) and Medumba (byv)](https://github.com/wikimedia/language-data/pull/393)
24. [Add Mampruli (maw)](https://github.com/wikimedia/language-data/pull/395)
25. [Add Maguindanaon (mdh)](https://github.com/wikimedia/language-data/pull/396)
26. [Update regional information automatically](https://github.com/wikimedia/language-data/pull/397)
27. [Updates languages of Macau](https://github.com/wikimedia/language-data/pull/398)
28. [Add Bamum (bax, bax-bamu) and Likpakpaanl (Konkomba; xon)](https://github.com/wikimedia/language-data/pull/399)
29. [Modify Punjabi language data](https://github.com/wikimedia/language-data/pull/400)
30. [Update territory information from upstream](https://github.com/wikimedia/language-data/pull/401)
31. [Add a redirect from pa-arab to pnb](https://github.com/wikimedia/language-data/pull/402)
32. [Add East Frisian Low Saxon to language data](https://github.com/wikimedia/language-data/pull/404)
33. [Update regional data from upstream](https://github.com/wikimedia/language-data/pull/405)
34. [Add Rana Tharu (thr) and Baltic Romani (Cyrillic, rml-cyrl)](https://github.com/wikimedia/language-data/pull/406)
35. [Add Lampung Api (ljp)](https://github.com/wikimedia/language-data/pull/407)
36. [Update langdb.yaml](https://github.com/wikimedia/language-data/pull/408)
37. [Update language data](https://github.com/wikimedia/language-data/pull/409)
38. [Update Shan (shn) autonym](https://github.com/wikimedia/language-data/pull/410)
39. [Modify Tajik language data](https://github.com/wikimedia/language-data/pull/411)
40. [Fix Tajik (tg) redirect](https://github.com/wikimedia/language-data/pull/413)
41. [Updating language data from upstream automatically](https://github.com/wikimedia/language-data/pull/415)
42. [Add Margi (mrt)](https://github.com/wikimedia/language-data/pull/414)
43. [Automatic update of territory information](https://github.com/wikimedia/language-data/pull/416)
44. [Change pap-aw autonym](https://github.com/wikimedia/language-data/pull/417)
45. [Updating territory-language information from upstream automatically](https://github.com/wikimedia/language-data/pull/419)
46. [Add Havu (hav)](https://github.com/wikimedia/language-data/pull/421)
47. [Add Ho (Latin)](https://github.com/wikimedia/language-data/pull/422)
48. [Updating territory-language information from upstream automatically](https://github.com/wikimedia/language-data/pull/423)
49. [Add Pazeh (pzh)](https://github.com/wikimedia/language-data/pull/425)
50. [Add Sasak (sas)](https://github.com/wikimedia/language-data/pull/426)
51. [Add Michif (crg)](https://github.com/wikimedia/language-data/pull/427)
52. [Redirect ks-arab to ks](https://github.com/wikimedia/language-data/pull/428)
53. [Updating territory-language information from upstream automatically](https://github.com/wikimedia/language-data/pull/429)
54. [Add Puno Quechua (qxp)](https://github.com/wikimedia/language-data/pull/430)
55. [Fix redirects for az and azb languages](https://github.com/wikimedia/language-data/pull/431)
56. [Updating territory-language information from upstream automatically](https://github.com/wikimedia/language-data/pull/432)
57. [Updating territory-language information from upstream automatically](https://github.com/wikimedia/language-data/pull/433)
58. [Add Rajasthani (raj)](https://github.com/wikimedia/language-data/pull/434)
59. [Add Dolgan to language data](https://github.com/wikimedia/language-data/pull/435)
60. [Fix redirects for aeb](https://github.com/wikimedia/language-data/pull/436)
61. [Add aig to language data](https://github.com/wikimedia/language-data/pull/437)
62. [Add Hadhrami Arabic (ayh)](https://github.com/wikimedia/language-data/pull/439)
63. [Fix regions in recently-added languages and add a test](https://github.com/wikimedia/language-data/pull/438)
64. [Add Awajún (agr)](https://github.com/wikimedia/language-data/pull/441)
...
- [Add Amir E. Aharoni email to composer.json](https://github.com/wikimedia/language-data/pull/379)
- [Updating PHP tests to run on ubuntu-latest](https://github.com/wikimedia/language-data/pull/424)
- [Update composer dependencies](https://github.com/wikimedia/language-data/pull/444)
...
- [Update npm dependencies](https://github.com/wikimedia/language-data/pull/443)
- [Updates for the unique autonyms test](https://github.com/wikimedia/language-data/pull/383)
- [Run npm audit fix 2025-06-30](https://github.com/wikimedia/language-data/pull/440)
